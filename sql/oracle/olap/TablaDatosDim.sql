...
CREATE TABLE DIMUBICACION (
    UBICACIONKEY        NUMBER(10) PRIMARY KEY,
    PAIS                VARCHAR2(100) NOT NULL,
    CIUDAD              VARCHAR2(100) NOT NULL,
    REGION              VARCHAR2(100)
);

ALTER TABLE DIMUBICACION ADD CONSTRAINT UK_DIMUBICACION UNIQUE (PAIS, CIUDAD);
...
CREATE TABLE DIMCATEGORIA (
    CATEGORIAKEY        NUMBER(10) PRIMARY KEY,
...
CREATE TABLE DIMPROVEEDOR (
    PROVEEDORKEY        NUMBER(10) PRIMARY KEY,
...
CREATE TABLE DIMCLIENTE (
    CLIENTEKEY          NUMBER(10) PRIMARY KEY,
...
CREATE TABLE DIMEMPLEADO (
    EMPLEADOKEY         NUMBER(10) PRIMARY KEY,
...
CREATE TABLE DIMMODALIDADPAGO (
    MODALIDADKEY        NUMBER(10) PRIMARY KEY,
...
CREATE TABLE DIMPRODUCTO (
    PRODUCTOKEY         NUMBER(10) PRIMARY KEY,
...
CREATE TABLE FACTVENTAS (
    FACTVENTAID             NUMBER(19) PRIMARY KEY,
...
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_TIEMPO FOREIGN KEY (TIEMPOKEY) REFERENCES DIMTIEMPO(TIEMPOKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_PRODUCTO FOREIGN KEY (PRODUCTOKEY) REFERENCES DIMPRODUCTO(PRODUCTOKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_CATEGORIA FOREIGN KEY (CATEGORIAKEY) REFERENCES DIMCATEGORIA(CATEGORIAKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_CLIENTE FOREIGN KEY (CLIENTEKEY) REFERENCES DIMCLIENTE(CLIENTEKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_PROVEEDOR FOREIGN KEY (PROVEEDORKEY) REFERENCES DIMPROVEEDOR(PROVEEDORKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_EMPLEADO FOREIGN KEY (EMPLEADOKEY) REFERENCES DIMEMPLEADO(EMPLEADOKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_MODALIDAD FOREIGN KEY (MODALIDADKEY) REFERENCES DIMMODALIDADPAGO(MODALIDADKEY);
ALTER TABLE FACTVENTAS ADD CONSTRAINT FK_FACT_UBICCLIENTE FOREIGN KEY (UBICACIONCLIENTEKEY) REFERENCES DIMUBICACION(UBICACIONKEY);
...
CREATE OR REPLACE TRIGGER TRG_DIMUBICACION_ID
BEFORE INSERT ON DIMUBICACION FOR EACH ROW
BEGIN
    IF :NEW.UBICACIONKEY IS NULL THEN
        SELECT SEQ_DIMUBICACION.NEXTVAL INTO :NEW.UBICACIONKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_DIMCATEGORIA_ID
BEFORE INSERT ON DIMCATEGORIA FOR EACH ROW
BEGIN
    IF :NEW.CATEGORIAKEY IS NULL THEN
        SELECT SEQ_DIMCATEGORIA.NEXTVAL INTO :NEW.CATEGORIAKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_DIMPROVEEDOR_ID
BEFORE INSERT ON DIMPROVEEDOR FOR EACH ROW
BEGIN
    IF :NEW.PROVEEDORKEY IS NULL THEN
        SELECT SEQ_DIMPROVEEDOR.NEXTVAL INTO :NEW.PROVEEDORKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_DIMCLIENTE_ID
BEFORE INSERT ON DIMCLIENTE FOR EACH ROW
BEGIN
    IF :NEW.CLIENTEKEY IS NULL THEN
        SELECT SEQ_DIMCLIENTE.NEXTVAL INTO :NEW.CLIENTEKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_DIMEMPLEADO_ID
BEFORE INSERT ON DIMEMPLEADO FOR EACH ROW
BEGIN
    IF :NEW.EMPLEADOKEY IS NULL THEN
        SELECT SEQ_DIMEMPLEADO.NEXTVAL INTO :NEW.EMPLEADOKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_DIMMODALIDADPAGO_ID
BEFORE INSERT ON DIMMODALIDADPAGO FOR EACH ROW
BEGIN
    IF :NEW.MODALIDADKEY IS NULL THEN
        SELECT SEQ_DIMMODALIDADPAGO.NEXTVAL INTO :NEW.MODALIDADKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_DIMPRODUCTO_ID
BEFORE INSERT ON DIMPRODUCTO FOR EACH ROW
BEGIN
    IF :NEW.PRODUCTOKEY IS NULL THEN
        SELECT SEQ_DIMPRODUCTO.NEXTVAL INTO :NEW.PRODUCTOKEY FROM DUAL;
    END IF;
END;
/

CREATE OR REPLACE TRIGGER TRG_FACTVENTAS_ID
BEFORE INSERT ON FACTVENTAS FOR EACH ROW
BEGIN
    IF :NEW.FACTVENTAID IS NULL THEN
        SELECT SEQ_FACTVENTAS.NEXTVAL INTO :NEW.FACTVENTAID FROM DUAL;
    END IF;
END;
/

BEGIN DBMS_OUTPUT.PUT_LINE('Triggers de auto-incremento creados.'); END;
/
